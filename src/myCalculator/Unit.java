...
public class Unit {
	...
	private void initialize() {
		...
		JComboBox comboBox1 = new JComboBox<Object>();
		...
		comboBox1.setModel(new DefaultComboBoxModel<Object>(new String[] {"Choose one...", "USD", "EUR", "GBP", "JPY", "AUD", "CAD", "CHF", "RMB", "RUPEE"}));
